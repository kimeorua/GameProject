...
|플레이어 죽음|보스 죽음|
|----:|:----:|
|![](./img/플레이어죽음.gif)|![](./img/보스죽음.gif)|

### [6주차]

1. 전투로직 추가 구현

보스 및 플레이어 간의 전투 상황에서 생기는 피격 및 사망 모션과 해당하는 로직을 완성 하였음, 추가로 클리어 및 게임오버 UI도 작성함.

2. UI 및 이펙트, 사운드 추가

보스가 플레이어를 인식하면 보스의 HP가 보이게 UI를 개선 하였으며, 게임 시작화면, 게임 일시정지, 종료 및 클리어 UI도 구현 하였음

|게임오버|게임클리어|일시정지|메인화면|
|----:|:----:|:----:|:----:|
|![](./img/사망UI.PNG)|![](./img/게임클리어UI.PNG)|![](./img/일시정지UI.PNG)|![](./img/메인화면UI.PNG)|
