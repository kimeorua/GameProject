...
|일반|공격| 공격키를 누를 경우|
|일반|방어| 방어키를 누를 경우|
|일반|피격| 몬스터의 공격에 맞았을 경우|
|일반|약 공격 스킬 사용| 약 공격 스킬(Q)를 누를 경우|
|일반|강 공격 스킬 사용| 강 공격 스킬(E)를 누를 경우
|일반|마법 스킬 사용| 마법 스킬(LCtrl)를 누를 경우|
|일반|물약 사용| 물약(R)를 누를 경우|
|일반|방어| 마우스 오른쪽버튼을 눌렀을 경우|
|일반|사망| 생명력이 0이하가 되었을 경우|
