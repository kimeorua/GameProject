...
-> 함수가 호출되면 파티클 이펙트를 재생하고 마법스킬 사용중을 true로 변경한다. 그 후 버프(마법스킬)의 유지 시간이 다되면 타이머를 이용하여, 파티클을끄로 마법 사용 중을 false로 바꾸는 함수를 호출 한다.
...
|검,방패 스킬|대검 스킬|포션|
|:----:|:----:|:----:|
|![](./img/w3/검방패스킬.gif)|![](./img/w3/대검스킬영상.gif)|![](./img/w3/포션.gif)|
